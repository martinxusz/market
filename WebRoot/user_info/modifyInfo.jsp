...
<HTML>
	<HEAD>
		...
		<LINK href="${ctx}/css/CalendarControl.css" type=text/css rel=stylesheet>
	</HEAD>
	<BODY>
<!-- SCRIPT language=JavaScript src="${ctx}/js/CalendarControl.js" type=text/JavaScript></SCRIPT -->
<SCRIPT language=JavaScript src="${ctx}/js/CalendarControl2.js" type=text/JavaScript></SCRIPT>
<SCRIPT language=JavaScript src="${ctx}/js/calendar.js" type=text/JavaScript></SCRIPT>
                ...
                <TD class=box_border vAlign=top height=400>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <TD class=blue_link height=30>出生日期 ：&nbsp;
                            <FONT face=宋体>         
				             <input name="birthday" onfocus="showCalendarControl(this);" value=<fmt:formatDate pattern="yyyy-MM-dd" value="${user.birthday }"/> type="text"> 
				             </FONT>
				 			</TD>
                            </TR>
                    <TR hidden>
                        <TD class=blue_link  height=30>头&nbsp;&nbsp;&nbsp;&nbsp;像&nbsp;&nbsp;&nbsp;&nbsp;：&nbsp;
                              ...
                              name="photo" value = "${user.photo}"><OPTION value=1 
                    ...
                    <TR><TD><INPUT id=passWordMod type=radio value=1 onclick="showMod()" name="passWordMod"><LABEL for=passWordMod >修改密码</LABEL></TD></TR>
                     					
                    <TR>
                      <TD height=30>
                        <TABLE id="modfiy_pwd" cellSpacing=0 cellPadding=0 width="100%" style="display:none"
                        align=center border=0>
                          <TBODY>
                          <TR>
                            <TD  class=blue_link  height=30>原始密码：</TD>
                            <TD><SPAN class=blue_link><INPUT 
                              class=input_modify id=txtOldPassword type=password 
                              name=oldPassword> </SPAN></TD></TR>
                          <TR>
                            <TD  class=blue_link  height=30>修改密码：</TD>
                            <TD><SPAN class=blue_link><INPUT 
                              class=input_modify id=txtNewPassword type=password 
                              name=newPassword> </SPAN></TD></TR>
                          <TR>
                            <TD  class=blue_link  width=100 height=30>确认密码：</TD>
                            <TD><SPAN class=blue_link><INPUT 
